            ...
            <div className="space-y-6">
                {researchList.map((research) => (
                    <div key={research.id}>
                        {/* カード本体 */}
                        <div
                            className="rounded-sm border transition-all hover:border-accent/30"
                            style={{
                                background: "var(--color-surface)",
                                borderColor: "var(--color-border-base)",
                                boxShadow: activeResearchId === research.id ? "0 4px 16px rgba(0,0,0,0.06)" : "none",
                                padding: "1.5rem",
                            }}
                        >
                            {/* カードヘッダー */}
                                        ...
                                        style={{
                                            background:
                                                activeResearchId === research.id
                                                    ? "var(--color-accent)"
                                                    : "var(--color-accent-bg)",
                                            color: activeResearchId === research.id ? "#fff" : "var(--color-accent)",
                                        }}
                                    >
                                        {activeResearchId === research.id
                                    ...
                                    {research.images.length > 1 && (
                                        <>
                                            ...
                                            <button
                                                type="button"
                                                onClick={() =>
                                                    setCurrentImageIndex((prev) => (prev + 1) % research.images.length)
                                                }
