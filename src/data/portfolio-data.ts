...
export const PROFILE: ProfileData = {
    ...
    description:
        "生成AI（LLM）を用いた知財探索システムの開発や、ハルシネーション検証の研究に取り組んでいます。大学発スタートアップでの活動を通し、事実に基づいたユーザーが安心して使えるシステムの設計から実装までに携わっています。",
    badges: [
...
export const WORKS: WorkData[] = [
    {
        ...
        description: `特許文書を起点にアイデア生成・類似特許検索・協業先マッチングを行うWebアプリです。
            数百万件の生データをクレンジングした特許公報や法人情報を管理する自前のDBと検索基盤をゼロから構築しています。
    ...
    },
    {
        ...
        description: `Doclingを用いて複雑な段組み・数式・図版を含む論文PDFを正確に構造化し、ブラウザ上でMarkdownとして表示するローカル専用ツールです。ブラウザの翻訳機能をそのまま使える点が特徴です。`,
