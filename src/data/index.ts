...
export const WORKS: WorkData[] = [
    {
        ...
        description:
            "特許文書を起点にアイデア生成・類似特許検索・協業先マッチングを行うWebアプリです。数百万件の生データをクレンジングした特許公報や法人情報を管理する自前のDBと検索基盤をゼロから構築しています。最大の特徴は、LLMの不確実な出力を事実と推測に切り分ける「情報の透明性」にあります。直接引用箇所を原文と双方向ハイライトするUIや、独自開発した原点適合率の定量評価を組み合わせることで、「根拠を辿れる状態でユーザーが安心してLLMの生成物を観察し、自らの洞察を引き出せる空間」を提供します。現在、最も力を入れて取り組んでいるプロジェクトです。",
        stack: [
            "Next.js",
            "TypeScript",
            "FastAPI",
    ...
    },
    {
        ...
        description:
            "自由ヶ丘執行委員会（学生組織）で利用するビンゴ大会の景品割り当てを自動化するWebアプリです。「例年なんとかなっている」で済まされていた手作業による人為的ミスや、当日の参加人数変動に伴う構造的な欠陥に対し、Fisher-Yatesシャッフルアルゴリズムを用いた番号割り当てロジックを実装することで根本から問題を解決しました。イベント本番でのミスゼロ運用を達成し、システムによる業務改善を実証しました。",
        ...
        items: [
            {
                ...
                period: "2年",
                usage: "インターン・研究",
                note: "メイン言語。FastAPIを用いたAPI構築や、Docling・SudachiPy等を利用した特許解析・データ処理で活用。日々の開発ではRuffを利用し、コードの品質を保っている。",
            },
            {
                name: "PostgreSQL",
                period: "1年半",
                usage: "インターン・研究",
                note: "数百万件の特許公報・法人情報データベースを構築。サーバーサイドカーソルを用いた省メモリなデータ移行や、PGroonga(全文検索)・pgvector(HNSWインデックス)を組み合わせたハイブリッド検索を運用。",
            },
            {
                name: "FastAPI",
                period: "1年半",
                usage: "インターン・個人開発",
                note: "PythonベースのバックエンドAPI構築。Pydanticを用いた堅牢な型定義や、Zip Bomb等のセキュリティ対策を施したファイル抽出エンドポイント、OpenAI互換APIを利用したLLM推論基盤を実装。",
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                period: "半年",
                usage: "インターン・個人開発",
                note: "Next.jsと組み合わせた開発の主軸。openapi-fetchを利用した型安全なAPI通信や、Zod・Drizzle ORM等と連携して活用。",
            },
            {
                name: "Next.js / React",
                period: "1年",
                usage: "インターン・個人開発",
                note: "App Routerを利用したフルスタック開発。BFF（Backend For Frontend）としてのDB構築や、Server Components/Actionsによるインフラ隠蔽を意識。",
            },
            {
                name: "Tailwind CSS",
                period: "1年",
        ...
        items: [
            {
                ...
                period: "1年",
                usage: "インターン・研究",
                note: "特許データベースとLLMを組み合わせた関連技術探索システム。RRF(逆順位融合)を用いたキーワード検索と意味検索の統合アルゴリズムを実装。",
            },
            {
                name: "プロンプトエンジニアリング",
                period: "1年半",
                usage: "インターン・研究",
                note: "ハルシネーションを抑え、事実に基づく出力を制御するための設計と、その評価手法の確立。複数LLMエージェントによる非同期の議論・調停プロンプトの設計。",
            },
            {
                name: "ストリーミング生成",
                period: "1年",
                usage: "インターン・個人開発",
                note: "SSE(Server-Sent Events)形式でのデータ送信と、チャンクパース処理を用いたリアルタイムなテキストのUIレンダリング。",
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                period: "半年",
                usage: "インターン・個人開発",
                note: "DockerfileやDocker Composeを用いた、複数コンテナ（API + APP + DBなど）の開発環境・運用環境の構築。",
            },
            {
                name: "Git / GitHub",
                period: "2年",
